...
import { ArrowLeft, Package, Tag, Folder, ExternalLink, ChevronLeft, ChevronRight, Expand, Settings, Download, Eye } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Skeleton } from "@/components/ui/skeleton";
import { Alert, AlertDescription } from "@/components/ui/alert";
import { getProductBySlug, getRelatedProducts, type ProductWithRelations } from "@/lib/actions/products";
                    ...
                    <Card className="h-full flex flex-col">
                      <CardContent className="p-6 flex-1 overflow-hidden flex flex-col">
                        <div className="flex items-center gap-2 text-lg mb-4 flex-shrink-0">
                          ...
                          <h3 className="font-semibold text-foreground">Caractéristiques techniques</h3>
                        </div>
