...
const HeroSection = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Reduced floating animation - only for background elements
  ...
  return (
    ...
    >
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/20 via-white to-gray-50/30">
        {/* Geometric shapes */}
        ...
        <Image
          ...
          quality={75}
          priority
          alt="Hava Group Background"
          className="object-cover opacity-90 hero-bg-image"
          sizes="100vw"
          placeholder="blur"
          blurDataURL="data:image/jpeg;base64,"
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          {/* CTA Button */}
          <div ref={ctaRef} className="flex justify-center" style={{ willChange: 'transform, opacity' }}>
            <Link
              href="#products"
